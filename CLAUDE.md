...
- After **20 minutes** without effective playback, the clock / weather idle screen appears (the timer is not blocked by physical inter-track classification; until then, last frame / dimmed standby per `chromeIdle`)
